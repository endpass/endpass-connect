...
export const PLUGIN_METHODS = {
  ...
  CONTEXT_GET_WIDGET_NODE: 'CONTEXT_GET_WIDGET_NODE',
  CONTEXT_SERVER_AUTH: 'CONTEXT_SERVER_AUTH',
  CONTEXT_SET_REQUEST_PROVIDER: 'CONTEXT_SET_REQUEST_PROVIDER',
  CONTEXT_SET_PROVIDER_SETTINGS: 'CONTEXT_SET_PROVIDER_SETTINGS',
  DIALOG_ASK: 'CONTEXT_ASK',
  MESSENGER_GROUP_ADD: 'MESSENGER_GROUP_ADD',
  MESSENGER_GROUP_REMOVE: 'MESSENGER_GROUP_REMOVE',
  MESSENGER_GROUP_SEND: 'MESSENGER_GROUP_SEND',
};
