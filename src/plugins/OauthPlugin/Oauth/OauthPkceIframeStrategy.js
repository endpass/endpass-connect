...
import IframeWindow from '@/plugins/OauthPlugin/Oauth/IframeWindow';
...
/** @type {OauthStrategy} */
export default class OauthPkceIframeStrategy {
  /**
   *
   ...
   */
  async getTokenObject(oauthServer, params) {
    ...
    const popupResult = await IframeWindow.open(oauthServer, {
      ...params,
      state,
      response_type: 'code',
