(function (global, factory) {
	...
	(global['endpass-connect'] = factory(global.os,global.tty,global.util,global.http,global.https,global.assert,global.stream,global.url,global.zlib));
	...
	var IDENTITY_SERVER_URL = 'https://identity-dev.endpass.com/api/v1.1';
	...
	function () {
	  ...
	  _createClass(IdentityService, [{
	    ...
	    value: function getAccounts() {
	      return axios$1.get("".concat(IDENTITY_SERVER_URL, "/accounts"), {
	        ...
	        return regeneratorRuntime.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                _context.next = 2;
	                return axios$1.post("".concat(IDENTITY_SERVER_URL, "/auth"), {
	                  email: email
	                });
	    ...
	    key: "startPolling",
	    value: function startPolling(handler) {
	      var _this = this;
	          ...
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                _context.prev = 0;
	                _context.next = 3;
	                return identityService.getAccounts();
